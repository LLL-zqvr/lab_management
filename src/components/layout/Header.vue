      ...
      <div class="avater-box">
        <div class="menu-box">
          <div class="usermessage">
            ...
            />
            <span class="usermessage-text"
              >{{ user.getUserName() }} {{ user.getRole() }}</span
            >
          </div>
...
ul li:hover {
  background-color: rgba(160, 154, 154, 0.5);
}
/* 抖动动画 */
@keyframes jitter {
  0% {
